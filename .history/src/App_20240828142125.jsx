...
function PageSelector() {
  ...
  return (
    <div className="flex justify-center items-center h-screen">
      <div className="w-[370px] h-[326px] bg-white border border-gray-200 shadow-lg rounded-md p-4 flex flex-col">
        ...
        <div className="mt-auto flex justify-end">
          <button className="px-6 py-2 bg-yellow-400 text-white rounded-md text-lg font-medium hover:bg-yellow-300 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-opacity-50 transition ease-in-out duration-150">
            Done
          </button>
        </div>
      </div>
